...
const ProductList = () => {
  ...
  const products = [
    { id: 1, name: 'Laptop', price: 20000000, description: 'High-performance laptop' },
    { id: 2, name: 'Smartphone', price: 5000000, description: 'Latest smartphone' },
    { id: 3, name: 'Headphones', price: 900000, description: 'Wireless headphones' },
    { id: 4, name: 'Keyboard', price: 600000, description: 'Mechanical keyboard' },
    { id: 5, name: 'Mouse', price: 300000, description: 'Gaming mouse' },
    { id: 6, name: 'Monitor', price: 2000000, description: '27-inch monitor' },
  ];
